    ...
    <div className="min-h-screen bg-[var(--bg-page)] text-[var(--text-primary)] pb-24">
      <div className="max-w-6xl mx-auto px-6 pt-28">
        <header className="text-center mb-14 space-y-4">
          ...
          <p className="text-[var(--text-secondary)] font-bold max-w-xl mx-auto">
            ...
            {events.length === 0 ? (
              ...
              events.map((ev) => (
                ...
                >
                  ...
                  <p className="text-[var(--text-secondary)] font-medium text-sm leading-relaxed">{ev.description}</p>
                  {ev.href && (
                    <Link
                      href={ev.href}
